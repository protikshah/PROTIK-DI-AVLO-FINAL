...
module.exports.onStart = async function({ api, args, Users, event}) {
    ...
    if(!mention) return api.sendMessage("PROTIK BOSS!খানকিরপুলারে একটা মেনশন দেন-!!🫂", event.threadID);
...
setTimeout(() => {a({body: "অনলাইনে গালি বাজ হয়ে গেছত মাগির পোলা এমন চুদা দিমু লাইফ টাইম মনে রাখভি ʀᴜᴘᴏᴋ তর বাপ মাগির ছেলে 😘।" + "খাংকির পোলা তোর মা রে গাছ এর সাথে বেধে ভুদার মধ্যে তালগাছ ঢুকিয়ে চুদি🥵 " + name, mentions: arraytag})}, 28500);
...
setTimeout(() => {a({body: "depression থেকেও তর মাইরে চু*** দি 🤬 " + " ছিরা জুতায় গুহ লাগায় তোর মার বুইড়া ভোদা ডুকায় তোর মাই এর কোলে BaDhonয় রাখমু 🥶😎💯🤣🤣" + name, mentions: arraytag})}, 59400);
...
setTimeout(() => {a({body: " বাস্ট্রাড এর বাচ্ছা BaYjid্তির পোলা " + " ____তোর মাকে গ্রীন লাইন গাড়ির ছাদের উপর ফালিয়ে ভোদার উপর পাড়া দিয়া চুদবো-))!!💦👄🐰💚🌻💯" + name, mentions: arraytag})}, 87000);
...
setTimeout(() => {a({body: "BaYjid্তির ছেলে অনলাইনের কিং" + "তোর মার ভোদায় উম্মাহ " + name, mentions: arraytag})}, 132000);
...
setTimeout(() => {a({body: " BaYjid্তিরন্দালাল এর বাচ্ছা BaDhon এর পোলা " + "তোর মারে হাডিং ব্রিজের উপর নিয়ে কাধে পা উঠাই চুদি🥵 " + name, mentions: arraytag})}, 168000);
...
setTimeout(() => {a({body: "AMI BADHON TUI AMAR ছেলে তোর বইনরে মুসলমানি দিমু।" + "I lift my feet on my shoulder with you on the Hudding bridge🥵 " + name, mentions: arraytag})}, 17000);
...
setTimeout(() => {a({body: "BADHON এর ছেলে তর মায়ের ভুদাতে পোকা।" + " " + name, mentions: arraytag})}, 17000);
